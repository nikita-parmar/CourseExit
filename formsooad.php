...
<html>
	...
	<body>
		<form name="q_and_o" onsubmit="return validateForm()" method="POST">
			<div class="question">Q1 SOOAD</div>
			...
			<div class="question">Q2 SOOAD</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Q3 SOOAD</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Q4 SOOAD</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Q5 SOOAD</div>
