<?php
	...
	{	
		...
		if(!empty($q1) && !empty($q2) && !empty($q3) && !empty($q4) && !empty($q5))
		{
			...
			{
				echo '<script type="text/javascript">alert("Your feedback is already submitted once");</script>';
			}
		}
	}
?>
...
<html>
	...
	<body>
		<form name="q_and_o" onsubmit="return validateForm()" method="POST">
			<div class="question">Do you know how OS works as a system software?</div>
			...
			<div class="question">Can you compare and analyse performance of various memory management, CPU scheduling, File handling and I/O operations?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Do you know effective research management and deadlock handling techniques by OS?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Did you get basic understanding of managing processes, files, I/O, memory by different OS?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Did you become familiar with shell scripts and its use?</div>
