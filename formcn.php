	...
	{	
		...
		if(!empty($q1) && !empty($q2) && !empty($q3) && !empty($q4) && !empty($q5))
		{
			...
			if(mysql_query($query))
			{
                              ...
                              echo '<script type="text/javascript">alert("Your feedback is submitted successfully!");</script>';		
			      header('Location:subjects1.html');        
                        }
			else
			{
				echo '<script type="text/javascript">alert("Your feedback has already been submitted once");</script>';
			}
		}
	}
?>
...
<html>
	...
	<body>
		<form name="q_and_o" onsubmit="return validateForm()" method="POST">
			<div class="question">Are you able to understand the basic terminologies in networking/data communication</div>
			...
			<div class="question">Can you simulate network topologywith appropriate networking devices</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Can you differentiate functionality of different OSI layers?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Are you able to understand IP addressing and subnetting?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Are you able to use various networking tools in various application and network layer?</div>
	  ...
	  <input type="submit" class="btn btn-default" name="logout" value="Logout" style="margin-top:30px ;margin-left:40px">
         </form>	
