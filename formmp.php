<?php
	...
	{	
		...
		if(!empty($q1) && !empty($q2) && !empty($q3) && !empty($q4) && !empty($q5))
		{
			...
			{
				echo '<script type="text/javascript">alert("Your feedback is already saved once");</script>';
			}
		}
	}
?>
...
<html>
	...
	<body>
		...
		<div class="question">Are you able to understand, how a processor works and able to assemble programs for 8086?</div>
			...
			<div class="question">Can you design 8086 based systems interfacing memory and I/O peripherals?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Are you able to understand techniques for improving performance of microprocessor?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Are you able to understand concept and application of RISC and CISC processors?</div>
		    ...
		    <div class="allOptions">
  			...
  			<div class="question">Are you able to compare the features of multi core processors?</div>
		    ...
		    <div class="allOptions">
	          ...
	          <input type="submit" class="btn" name="submitButton" value="Submit" style="margin-top:30px ;margin-left:40px">
		</form>
	        
         <form  action="logout.php" method="GET">
	   <input type="submit" class="btn" name="logout" value="Logout" style="margin-top:30px ;margin-left:40px">
	 </form>	
